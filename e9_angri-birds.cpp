...
int main(){
    ...
    int dist_object=503, angulo=45, dist_alcanzada;
    float gravedad=9.8,vel_inicial;
    string pregunta="si";
    ...
    while(pregunta=="si"){
        ...
        // opcion 2
            ...
            */
            ...
            int vel_correcta; // variable que toma la velocidad necesaria para llegar al objetivo
            int dist_correcta; // distancia que se alcansa con la velocidad correcta
            ...
            while(n1 <= n2){
                ...
                */
                ...
                n1+=1; // a esta variable se le ira sumando uno hasta llegar al valor final del rango
            }
